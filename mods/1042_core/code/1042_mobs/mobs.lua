...
core.register_entity("1042_core:pig", {
    initial_properties = {
        visual = "mesh",
        mesh = "pig.gltf",
        textures = {
    ...
    on_death = function(self, player)
        ...
        if core.get_node(pos).name == "air" then
            core.set_node(pos, {name = "1042_core:pork_raw"})
        else
            core.item_drop(ItemStack("1042_core:pork_raw"), self.object, pos)
        end
    end,
...
dofile(core_1042.get_core_mod_path("1042_mobs") .. "/mob_spawning.lua")
